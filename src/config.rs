...
lazy_static::lazy_static! {
    ...
    // claude: TUHH – eigenes Konfig-Verzeichnis (%APPDATA%\RustDesk_TUHH), verhindert Kollision
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk_TUHH".to_owned());
